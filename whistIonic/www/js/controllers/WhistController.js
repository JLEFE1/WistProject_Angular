(function (){
    'use strict';
     ...
     angular.module('gamesApp').controller('WhistController',['$scope', 'whistService', 'rankingService', WhistController]);



     function WhistController($scope, whistService, rankingService) {

         $scope.titleObject = whistService.getTitleObject();

         $scope.game =  whistService.startNewGame();
